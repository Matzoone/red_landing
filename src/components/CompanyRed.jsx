...
const CompanyRed = () => {
  return (
    <div>
      <Header />
      <section className="header bg-red-600 text-white py-16 ">
        <div className="container mx-auto  text-center">
          <h1 className="text-4xl font-bold my-8">به سایت رد سرور خوش آمدید</h1>
          <p className="text-lg m-7">
            رد سرور یک بستر مناسب برای عبور از فیلترینگ با سرعت بالا، بدون قطعی
            و با نازل‌ترین قیمت.
          </p>
          <button className="bg-black text-white px-6 py-3 my-6 rounded hover:bg-gray-800 transition">
            تست رایگان
          </button>
        </div>
      </section>
